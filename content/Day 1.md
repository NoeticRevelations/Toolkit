...
modified: 2026-02-24T17:11:03.987+00:00
cssclasses: ""
---
...
graph LR
    %% Styling
    classDef blueNode fill:#ffffff,stroke:#3b65a5,stroke-width:4px,color:#000,font-size:16px,text-align:center
    classDef orangeNode fill:#ffffff,stroke:#d47631,stroke-width:4px,color:#000,font-size:16px,text-align:center

    %% Nodes
    Top["To engage the person, they need to understand<br/>the <b style='color:#3b65a5'>physical</b> and <b style='color:#d47631'>psychological</b> interplay"]:::blueNode
    
    Bottom["Key focus on developing a<br/><b>shared understanding</b> of their problems"]:::orangeNode

     Styling
    classDef step1 fill:#d1f2e5,stroke:#055f4d,stroke-width:2px,color:#000,text-align:left
    classDef step2 fill:#f8dcca,stroke:#c85527,stroke-width:2px,color:#000,text-align:left
    classDef step3 fill:#dbeaf5,stroke:#1e5b87,stroke-width:2px,color:#000,text-align:left
    classDef step4 fill:#f5d0f1,stroke:#932087,stroke-width:2px,color:#000,text-align:left

    %% Nodes
    A["<b>Identify the main presenting mental health problem</b><br/>Explore further > Funnel, Ws, FIDO / FIND, Triggers"]:::step1
    
    B["<b>Identify any LTCs:</b><br/>Explore further > Experience, Knowledge, Self-management & Support"]:::step2
    
    C["<b>Explore ABCEs associated with main presenting mental health problem:</b><br/>Explore further > Links between mental health and LTC, Funnel, WWW's FIDO / FIND"]:::step3
    
    D["<b>Explore impact of main presenting mental health problem:</b><br/>On valued life areas (Work, Social, Home, Private Leisure, Relationships)<br/><mark>Impact on self-management of LTC</mark>"]:::step4
...
```mermaid
		graph TD
    %% Styling
    classDef greenLabel fill:#b9eed6,stroke:none,color:#083c34,font-weight:bold,font-size:16px
    classDef greenDesc fill:#d2f4e6,stroke:none,color:#083c34,text-align:left
    
    classDef blueLabel fill:#d7e6f5,stroke:none,color:#083c34,font-weight:bold,font-size:16px
    classDef blueDesc fill:#e5eff8,stroke:none,color:#083c34,text-align:left
    
    classDef orangeLabel fill:#f5cbb4,stroke:none,color:#083c34,font-weight:bold,font-size:16px
    classDef orangeDesc fill:#fae0d2,stroke:none,color:#083c34,text-align:left

    %% Nodes and Connections
    NL["No Link"]:::greenLabel --- ND["Managing LTC well and does not impact on<br/>psychological difficulty for which seeking help"]:::greenDesc
    
    CL["Causal Link"]:::blueLabel --- CD["LTC is perceived as the cause of the<br/>psychological difficulty."]:::blueDesc
    
    IL["Impacted"]:::orangeLabel --- ID["Deterioration of self-management of LTC as<br/>a result of the psychological difficulty"]:::orangeDesc

    %% The cyclic connection between Causal and Impacted
    CD <-->|"Both causal & impacted?"| ID
